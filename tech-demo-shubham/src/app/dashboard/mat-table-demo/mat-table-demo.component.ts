...
export class MatTableDemoComponent implements AfterViewInit {
  ...
  // In Angular lifecycle this method is executed when the component gets initialized
  ngAfterViewInit() {
    this.dataSource.paginator = this.paginator; // Assign paginated data to the datasource
    this.dataSource.sort = this.sort;
  }


  applyFilter(event: Event) {
    const filterValue = (event.target as HTMLInputElement).value // Takes the filter value from HTML page;
